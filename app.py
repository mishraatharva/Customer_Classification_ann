...
import pandas as pd
import pickle
from utils import load_encoders, load_model, load_scaler
from constants import *

# Load the trained model
# model = tf.keras.models.load_model('model.h5')
model = load_model(ROOT_DIR_MODEL)


# Load the encoders and scaler
encoder = load_encoders(ROOT_DIR_ENCODER)
# with open('label_encoder_gender.pkl', 'rb') as file:
#     label_encoder_gender = pickle.load(file)
scaler = load_scaler(ROOT_DIR_SCALER)

label_encoder_gender = encoder[0]
geo_one_hot_encoder = encoder[1]
